...
KERNEL_URI="https://github.com/microsoft/WSL2-Linux-Kernel/archive/refs/tags/rolling-lts/wsl/${MSV}.tar.gz -> linux-msft-${OKV}.tar.gz"
...
universal_unpack() {
	...
	mv WSL2-Linux-Kernel-rolling-lts-wsl-${MSV} linux-${KV_FULL} || die
